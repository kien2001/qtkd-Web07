    ...
    <div class="pop-up-container" :style="objectStyle">
        <div class="pop-up" :class="{ show: isShow }">
            ...
            <div class="pop-up__footer">
                <Button name="Huỷ bỏ" border="#D3D7DE" color="#fff" @clickBtn="closePopUp" colorHover="#E2E4E9" />
                <Button name="Đồng ý" :color="colorBtn" :colorHover="colorHoverBtn" colorText="#FFFFFF"
                    @click="handleClick" />
            </div>
        </div>
    </div>
